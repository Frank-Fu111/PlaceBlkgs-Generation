...
def train_step2(data_dir:str, db_scan_file:str, run_id:int, device:int,
    ...
    # Load the best model
    best_model = '/home/frankfu/Tomography/ml/RL/best_model/rl_best_251018_095732mult_b.pth'
    model.load_state_dict(torch.load(f"{best_model}"))
...
if __name__ == "__main__":
    device = 0
    data_dir = "/home/frankfu/Tomography/DataGeneration/ISPD_2015/mgc_des_perf_a/train/run_sub_0/run_50"
