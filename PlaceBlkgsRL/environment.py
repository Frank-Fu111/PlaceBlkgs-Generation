...
class TomographyEnv(gym.Env):
    ...
    def __init__(self, data_dir:str, init_sample:int = 30,
        ...
        self.base_dir = "/home/frankfu/Tomography/ml/PlaceBlkgComp/best_model"
        self.feature_file = f"{self.data_dir}/run_0.npy"
        self.model_file = f"{self.base_dir}/step2_model_0_20251117_073154_best.pt"
        ...
        self.observation_space = spaces.Tuple((spaces.Box(low=-1, high=np.inf,
                                        ...
                                        dtype=np.float32)))
        self.action_space = spaces.Discrete(15)  # Example action space: 14 possible actions
        self.state = None
